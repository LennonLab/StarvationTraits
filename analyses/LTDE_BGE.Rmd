...
# Merge Datasets
BGE.data.full <- rbind(KBS0802.data, KBS0707.data)
...
prod_plot <- plot(Conc.Cells ~ jitter(Conc), data = BGE.707.w, 
                 pch = 22, cex = 3, col = "black", bg = "gray", lwd = 2.5,
                 xaxt = 'n', yaxt = 'n', xlab = '', ylab = '',
...
# mtext("(mM Carbon)", side = 2, line = 3, cex = 0.8)
box(lwd = 3)
resp_plot <- plot(Conc.Resp ~ jitter(Conc), data = BGE.707.w, 
                 pch = 22, cex = 3, col = "black", bg = "gray", lwd = 2.5,
                 xaxt = 'n', yaxt = 'n', xlab = '', ylab = '',
...
# mtext("(mM Carbon)", side = 2, line = 3, cex = 0.8)
box(lwd = 3)
bge_plot <- plot(BGE ~ jitter(Conc), data = BGE.707.w, 
                 pch = 22, cex = 3, col = "black", bg = "gray", lwd = 2.5,
                 xaxt = 'n', yaxt = 'n', xlab = '', ylab = '',
                 ylim = c(0.02, 0.18), xlim = c(0, 10))
axis(side=2, lwd.ticks = 2, tck=-0.04, labels=T, las = 1, cex.axis = 1.5)
axis(side=2, lwd.ticks = 2, tck= 0.02, labels=F)
axis(side=4, lwd.ticks = 2, tck=-0.02, labels=F)
axis(side=4, lwd.ticks = 2, tck= 0.02, labels=F)
