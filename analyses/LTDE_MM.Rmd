...
# Calculate BGE
BGE.802.w$BGE <- BGE.802.w$CPM.p.Cells / (BGE.802.w$CPM.p.Cells + BGE.802.w$CPM.p.Resp)
...
box(lwd = 2)
resp_plot <- plot(Conc.Resp ~ log10(Conc), data = BGE.802.w, 
                 pch = 15, cex = 1.5, col = "cornflowerblue",
                 xaxt = 'n', yaxt = 'n', xlab = '', ylab = '',
                 ylim = c(0.1, 0.9))
axis(side=2, lwd.ticks = 2, tck=-0.05, labels=T, las = 1)
...
axis(side = 1, lwd.ticks = 2, cex.axis = 1, tck = -0.01,
     at = log10(c(seq(0.1, 1, by = 0.1), seq(1, 10, by = 1))), labels =F)
axis(side = 1, lwd.ticks = 2, cex.axis = 1, tck = 0.03,
     at = log10(c(seq(0.1, 1, by = 0.1), seq(1, 10, by = 1))), labels =F)
#axis(side = 3, lwd.ticks = 2, cex.axis = 1, tck = -0.01,
#     at = log10(c(seq(0.1, 1, by = 0.1), seq(1, 10, by = 1))), labels =F)
#axis(side = 3, lwd.ticks = 2, cex.axis = 1, tck = 0.01,
...
test1 <- lm(BGE ~ log10(Conc), data = BGE.802.w)



head(BGE.802.w)

par(mar = c(5,5,0.5,0.5), oma = c(0.5, 0.5, 0.5, 0.5))
layout(1)
plot(Conc.Sup ~ Conc, data = BGE.802.w,
     xlab = "Succinate (mM)", ylab = "Supernatant (mM C)")
abline(a = 0, b = 1)
