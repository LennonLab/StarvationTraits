...
KBS0707.1p <- succ.data[succ.data$Tube == "Tube3" & succ.data$Sample == "Cells", 2] * 5151/1800
KBS0707.1r <- succ.data[succ.data$Tube == "Tube3" & succ.data$Sample == "Trap", 2] * 500/100
KBS0707.1s <- succ.data[succ.data$Tube == "Tube3" & succ.data$Sample == "Supp", 2] * 5150/100

KBS0707.2p <- succ.data[succ.data$Tube == "Tube4" & succ.data$Sample == "Cells", 2] * 5151/1800
KBS0707.2r <- succ.data[succ.data$Tube == "Tube4" & succ.data$Sample == "Trap", 2] * 500/100
KBS0707.2s <- succ.data[succ.data$Tube == "Tube4" & succ.data$Sample == "Supp", 2] * 5150/100

KBS0707.3p <- succ.data[succ.data$Tube == "Tube5" & succ.data$Sample == "Cells", 2] * 5151/1800
KBS0707.3r <- succ.data[succ.data$Tube == "Tube5" & succ.data$Sample == "Trap", 2] * 500/100
KBS0707.3s <- succ.data[succ.data$Tube == "Tube5" & succ.data$Sample == "Supp", 2] * 5150/100

control.p <- succ.data[succ.data$Tube == "Tube2" & succ.data$Sample == "Cells", 2] * 5151/1800
control.r <- succ.data[succ.data$Tube == "Tube2" & succ.data$Sample == "Trap", 2] * 500/100
control.s <- succ.data[succ.data$Tube == "Tube2" & succ.data$Sample == "Trap", 2] * 5150/100

blank.p <- succ.data[succ.data$Tube == "Tube1" & succ.data$Sample == "Cells", 2] * 5151/1800
blank.r <- succ.data[succ.data$Tube == "Tube1" & succ.data$Sample == "Trap", 2] * 500/100
blank.s <- succ.data[succ.data$Tube == "Tube1" & succ.data$Sample == "Supp", 2] * 5150/100
...
bge_plot <- barplot(massB, main = "Succinate Metabolism Mass Balance",
        ...
        las = 1, cex.lab = 1.5, ylim = c(0,1), xlim = c(0, 3.2),
        space = c(0, 0.1, 0.1), 
