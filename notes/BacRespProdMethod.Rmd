...
plot <- plot(obs.log ~ exp.log, cex = 2, las = 1, cex.lab=1.5, pch = 22,
             xlab = expression(paste("Expected Recovery (log"[10], " CPM)")), 
             ylab = expression(paste("Oberved Recovery (log"[10], " CPM)")), 
...
points(obs.log ~ exp.log, cex = 2, pch = 22, lwd=3, col="black", bg = "gray")
