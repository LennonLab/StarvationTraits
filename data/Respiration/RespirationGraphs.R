...
means <- c(A701_mean, A7011_mean, B7011_mean, C7011_mean, D7011_mean, A7011b_mean, B7011b_mean, 
           C7011b_mean, D7011b_mean, A7013_mean, B7013_mean, C7013_mean, D7013_mean, A702_mean, 
           A7022_mean, B7022_mean, C7022_mean, D7022_mean, A7025_mean, B7025_mean, C7025_mean, 
           D7025_mean, A7026_mean, B7026_mean, C7026_mean, D7026_mean, A703_mean, A7031_mean, 
           B7031_mean, C7031_mean, D7031_mean, A7032_mean, B7032_mean, C7032_mean, D7032_mean, 
           A7034_mean, B7034_mean, C7034_mean, D7034_mean, A710_mean, A7101_mean, B7101_mean, 
           C7101_mean, D7101_mean, A7102_mean, B7102_mean, C7102_mean, D7102_mean, A7103_mean, 
           B7103_mean, C7103_mean, D7103_mean, A723_mean, A7231_mean, B7231_mean, C7231_mean, 
           D7231_mean, A7232_mean, B7232_mean, C7232_mean, D7232_mean, A7233_mean, B7233_mean, 
           C7233_mean, D7233_mean, A724_mean, A7241_mean, B7241_mean, C7241_mean, D7241_mean, 
           A7242_mean, B7242_mean, C7242_mean, D7242_mean, A7243_mean, B7243_mean, C7243_mean, 
           D7243_mean)

sems  <- c(A701_sem, A7011_sem, B7011_sem, C7011_sem, D7011_sem, A7011b_sem, B7011b_sem, 
           C7011b_sem, D7011b_sem, A7013_sem, B7013_sem, C7013_sem, D7013_sem, A7022_sem, 
           B7022_sem, C7022_sem, D7022_sem, A7025_sem, B7025_sem, C7025_sem, D7025_sem,
           A7026_sem, B7026_sem, C7026_sem, D7026_sem, A7031_sem, B7031_sem, C7031_sem, 
           D7031_sem, A7032_sem, B7032_sem, C7032_sem, D7032_sem, A7034_sem, B7034_sem, 
           C7034_sem, D7034_sem, A710_sem, A7101_sem, B7101_sem, C7101_sem, D7101_sem, 
           A7102_sem, B7102_sem, C7102_sem, D7102_sem, A7103_sem, B7103_sem, C7103_sem, 
           D7103_sem, A723_sem, A7231_sem, B7231_sem, C7231_sem, D7231_sem, A7232_sem, 
           B7232_sem, C7232_sem, D7232_sem, A7233_sem, B7233_sem, C7233_sem, D7233_sem, 
           A724_sem, A7241_sem, B7241_sem, C7241_sem, D7241_sem, A7242_sem, B7242_sem, 
           C7242_sem, D7242_sem, A7243_sem, B7243_sem, C7243_sem, D7243_sem)

bp <-barplot(means), xlab = "Isolate",ylab "Cellular Respiration (uM/Hr)", names.arg = c("A701", "A7011", "B7011", "C7011", "D7011", "A7011b", "B7011b", "C7011b", "D7011b", "A7013", "B7013", "C7013", "D7013", "A702", "A7022", "B7022", "C7022", "D7022", "A7025", "B7025", "C7025", "D7025", "A7026", "B7026", "C7026", "D7026", "A703", "A7031", "B7031", "C7031", "D7031", "A7032", "B7032", "C7032", "D7032", "A7034", "B7034", "C7034", "D7034", "A710", "A7101", "B7101", "C7101", "D7101", "A7102", "B7102", "C7101", "D7102", "A7103", "B7103", "C7103", "D7103", "A723", "A7231", "B7231", "C7231", "D7231", "A7232", "B7232", "C7232", "D7232", "A7233", "B7233", "C7233", "D7233", "A724", "A7241", "B7241", "C7241", "D7241", "A7242", "B7242", "C7242", "D7242", "A7243", "B7243", "C7243", "D7243")
